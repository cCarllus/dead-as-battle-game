...
export const DEFAULT_THIRD_PERSON_CAMERA_CONFIG: Readonly<ThirdPersonCameraConfig> = {
  ...
  shoulderOffsetY: 0.12,
  shoulderOffsetZ: 0.22,
  targetShoulderOffsetX: 0.36,
  targetLeadDistance: 0.52,
  cameraTargetOffsetY: 0.12,
  crouchHeightOffset: -0.22,
  crouchTargetOffsetY: -0.16,
  sprintDistanceOffset: 0.08,
  sprintLeadOffset: 0.16,
  ...
  baseFovRadians: (66 * Math.PI) / 180,
  sprintFovRadians: (71 * Math.PI) / 180,
  rollFovRadians: (73 * Math.PI) / 180,
  parkourFovRadians: (72 * Math.PI) / 180,
  userFovAdjustmentRadians: 0,
  minAllowedFovRadians: (55 * Math.PI) / 180,
  maxAllowedFovRadians: (95 * Math.PI) / 180,
  followLerpSpeed: 11.5,
  rotationLerpSpeed: 20,
  fovLerpSpeed: 8.5,
